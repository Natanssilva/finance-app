...
<body class="bg-gray-800 min-h-screen flex items-center justify-center">
    ...
    <h1 class="text-2xl text-white text-center absolute top-20 w-full animate__animated animate__backInRight ">Seja bem-vindo ao Finance App, o lugar certo para suas finanças !</h1>
</body>
</html>
